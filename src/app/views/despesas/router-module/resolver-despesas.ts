...
export const selecionarTodasDespesasResolve:
    ResolveFn<ListarDespesasViewModel[]> = () => {
        return inject(DespesasService).selecionarTodos()
    }

export const selecionarDespesasPorId:
    ResolveFn<FormDespesaViewModel> = (route: ActivatedRouteSnapshot) => {
        return inject(DespesasService).selecionarPorId(route.params['id'])
    }

export const visualizarDespesaCompletaResolve:
    ResolveFn<VisualizarDespesasViewModel> = (route: ActivatedRouteSnapshot) => {
